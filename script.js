document.addEventListener('DOMContentLoaded', () => {
    ...
    const flowerData = [
        ...
        { type: 'phrase', text: "Haces que mi mundo sea un lugar infinitamente mejor. 🌻", icon: "💛" , track: "Aprender_A_Quererte.mp3"},
        { type: 'phrase', text: "Eres muy importante para mí, más de lo que las palabras pueden expresar. ❤️", icon: "🌷" , track: "Besame.mp3"},
        { type: 'phrase', text: "Eres mi persona favorita en todo el mundo entero. 👫", icon: "🌺" , track: "Cuando_Nadie_Ve.mp3"},
        { type: 'phrase', text: "Gracias por tu paciencia infinita, tu amor y tu luz. 💖", icon: "🌸" , track: "Die_For_You.mp3"},
        { type: 'phrase', text: "Aprecio cada pequeño momento y detalle que compartimos. 🕰️", icon: "🌻" , track: "Do_I_Wanna_Know.mp3"},
        { type: 'phrase', text: "Conocerte fue el mejor regalo que me pudo dar la vida. 💙", icon: "🎁" , track: "Don_Omar.mp3"},
        { type: 'phrase', text: "Mi corazón sonríe cada vez que pienso en ti. 😊", icon: "💓" , track: "Dulce_Cancion.mp3"},
        { type: 'phrase', text: "Eres mi lugar seguro y mi aventura más grande. 🚀", icon: "🌠" , track: "Just_the_way_you_are.mp3"},
        { type: 'phrase', text: "Me haces sentir que todo es posible. ✨", icon: "💫" , track: "Llamado_de_Emergencia.mp3#t=10,68"},
        { type: 'phrase', text: "Amo la forma en que ves el mundo y cómo me haces parte de él. 🌎", icon: "🌻" , track: "Locos.mp3#t=10,85"},
